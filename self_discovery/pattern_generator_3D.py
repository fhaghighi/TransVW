...
parser.add_option("--data_dir", dest="data_dir", help="the path to pre-training dataset", default=None, type="string")
parser.add_option("--save", dest="save", help="the path to save processed 3D cubes", default="./TransVW_data", type="string")
            ...
            if label not in visited_labels:
                ...
                for i in range (len(train_images_list)):
                    if train_images_list[i]==file_name:
                        ref_selected[0,i]=1
                        break
    print("number of previous coordinates:", len(coordinates))
